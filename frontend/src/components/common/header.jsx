...
import { Box, AppBar, IconButton, InputBase, Drawer, Button, Link, List, ListItemButton, Menu, MenuItem } from '@mui/material';
    ...
    return (
        <>
            <AppBar className="AppBar" sx={{
                ...
                <IconButton onClick={handleClick} sx={{ mr: 2, display: { xs: "block", md: "none" } }}>
                    <AccountCircleIcon />
                </IconButton>
